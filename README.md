...
The regression's intercept — alpha, the drift the market does not explain — is stored too, and the chart shows it annualized as a trailing statistical residual, not a forecast.
