...
<h1>Stocks in context.</h1><p class="muted">Choose a stock to inspect its price history, unusual moves, and collected event evidence. Each chart is self-contained and works offline.<br><a href="factors.html" style="color:var(--accent)">Compare Beta &amp; Alpha across all stocks →</a><br><a href="insight.html" style="color:var(--accent)">Insight: reported vs true AI capex + credit stress →</a></p>
